...
//        double *NPar_count; cudaMallocManaged(&NPar_count,sizeof(double)); NPar_count[0] = 0;
        ...
        begin=clock();
        propagate<<<numBlocks, blockSize>>>(devState.data().get(), d_sig0.data().get(), d_dx2.data().get(), d_dx4.data().get(), d_sig.data().get(), d_NPar_count.data().get(), TN, NPar, Nc, res, dt, d_step.data().get(), NPix1, NPix2, NPix3, Ngrad, d_grad.data().get(), d_T2.data().get(), d_Pij.data().get(), ptr);
